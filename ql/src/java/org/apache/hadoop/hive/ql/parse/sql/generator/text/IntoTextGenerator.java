 ...
 *
 */
public class IntoTextGenerator extends BaseTextGenerator {

  @Override
  protected String textGenerate(CommonTree root, TranslateContext context) throws Exception {
    if (root.getChildCount() == 2) {
      // COLUMNS will be ignored
      return root.getText() + " table " + textGenerateChildIndex(root, context, 0);
    } else {
      throw new SqlParseException("unsupported syntax for sql AST node: " + root.getText());
    }
  }
}